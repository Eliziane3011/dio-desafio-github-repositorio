...
/*Classe de exemplo para o exe da aula 01
Operadores Lógicos e relacionais, Controle de fluxo
e blocos.*/
...
public class ExercicioAula01 {
	...
	public static void main(String[] args) {
		...
		// System.out.println("s2 != c1 ");char não poder ser comparado com String
		// System.out.println("s3 != i1 ");comparação impossível
